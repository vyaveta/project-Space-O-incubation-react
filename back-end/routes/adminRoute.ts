...
const {
     adminRegister , adminAuthentication , getAllUsers , blockClient ,
     getApplications , changeApplicationStatus , getRocketDetails ,
     getApprovedAndNonAllocatedApplications , allocateSeatForClient
     } 
